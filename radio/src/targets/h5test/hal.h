...
#define LED_STRIP_GPIO                    GPIO_PIN(GPIOA, 3) // TIM2_CH4
...
#define LED_STRIP_TIMER_DMA_STREAM        LL_DMA_CHANNEL_6
#define LED_STRIP_TIMER_DMA_IRQn          GPDMA2_Channel6_IRQn
#define LED_STRIP_TIMER_DMA_IRQHandler    GPDMA2_Channel6_IRQHandler
