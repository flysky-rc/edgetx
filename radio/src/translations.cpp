...
const char STR_RESET_SESSION[] = TR_RESET_SESSION;
...
const char STR_GHOST_MODULE_CONFIG[] = TR_GHOST_MODULE_CONFIG;
const char STR_GPS_MODEL_LOCATOR[] = TR_GPS_MODEL_LOCATOR;
const char STR_REFRESH[] = TR_REFRESH;
