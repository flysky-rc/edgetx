...
#define TR_RFPOWER_AFHDS2_1           "Défaut"
#define TR_RFPOWER_AFHDS2_2           "Haut"
...
#define TR_SUBTRIMMODES_1              STR_CHAR_DELTA " (centre seulement)"
